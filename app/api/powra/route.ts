...
export async function POST(request: Request) {
	try {
		...
		const newPOWRA = await prisma.pOWRA.create({
			data: {
				status: data.status,
				headerFields: JSON.parse(JSON.stringify(data.headerFields)) as Prisma.InputJsonValue,
				beforeStartChecklist: JSON.parse(JSON.stringify(data.beforeStartChecklist)) as Prisma.InputJsonValue,
				controlMeasures: JSON.parse(JSON.stringify(data.controlMeasures)) as Prisma.InputJsonValue,
