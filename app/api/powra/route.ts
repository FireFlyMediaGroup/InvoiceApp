...
import { PrismaClient, POWRAStatus } from '@prisma/client';
...
export async function POST(request: Request) {
  try {
    ...
    const requiredFields: (keyof POWRAData)[] = ['status', 'headerFields', 'beforeStartChecklist', 'controlMeasures'];
    ...
    const newPOWRA = await prisma.POWRA.create({
      data: {
        ...
        beforeStartChecklist: data.beforeStartChecklist,
